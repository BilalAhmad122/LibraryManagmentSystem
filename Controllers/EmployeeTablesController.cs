...
namespace LibraryManagmentSystem.Controllers
{
    public class EmployeeTablesController : Controller
    {
        ...
        public ActionResult Create()
        {
            ...
            ViewBag.DesignetionID = new SelectList(db.DesignationTables, "DesignetionID", "Name");
            return View();
        }
        ...
        public ActionResult Create( EmployeeTable employeeTable)
        {
            ...
            ViewBag.DesignetionID = new SelectList(db.DesignationTables, "DesignetionID", "Name", employeeTable.DesignetionID);
            return View(employeeTable);
        }
