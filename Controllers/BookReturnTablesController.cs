...
namespace LibraryManagmentSystem.Controllers
{
    public class BookReturnTablesController : Controller
    {
        ...
        {
            ViewBag.BookID = new SelectList(db.BookTables, "BookID", "BookType");
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "BookReturnID,BookID,EmployeeID,UserID,IssueDate,ReturenDate,CurentDate")] BookReturnTable bookReturnTable)
        {
            if (ModelState.IsValid)
            {
